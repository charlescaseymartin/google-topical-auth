...
prog = 'Google Authority Generator'
...
def get_authority_keywords(keywords: [str], keyword_file: str, output_file: str):
    results = {}
...
if __name__ == '__main__':
    ...
    get_authority_keywords(keywords, keywords_file, output_file)
